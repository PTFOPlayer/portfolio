    ...
    <div className="topbar">
      <div className="top">
        <div className="top-left">
          <UserAgent mobile>
            <a className="bmc" href="https://www.buymeacoffee.com/WhiskyAKM"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" /></a>
          </UserAgent>
          <a href="https://github.com/PTFOPlayer/"><i className="fab fa-github"></i></a>
        </div>
        <div className="top-center">
          <ul className="top-list">
            ...
            <li className="top-list-item"><a href='/#/tutorials' className="inherit">Tutorials</a></li>
            <UserAgent mobile>
