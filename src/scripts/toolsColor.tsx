  ...
  public static tool(tool: string) {
    ...
    let toolSwitch = (t: string) => {
      switch (t) {
        ...
        case "cuda":
          return <p className="cuda"><i className="fas fa-microchip" /> CUDA </p>
        case "rocm":
          return <p className="rocm"><i className="fas fa-fire" /> ROCm </p>
        case "llama.cpp":
          return <p className="llamacpp"><i className="fas fa-brain" /> Llama.cpp </p>
        default:
          return <p>{t}</p>
      }
    }
