  ...
  return (
    <>
      ...
      <div className="osexp">
        ...
        <br />
        <p>
          Going deeper into OS choice, why <span className="fedora">Fedora</span>? Because I wanted something
          that had a high level of hardware compatibility and a large package
          repository. DNF has a lot of packages available, is fast and Delta RPM
          saves some download time when doing large updates. I ditched nvidia
          GPU's entierly so now I can fully enjoy modern wayland compositors
          that Fedora offers by default.
        </p>
      </div>
    </>
  );
